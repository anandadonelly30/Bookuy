    ...
    <div class="mobile-container">
        ...
        <div class="header-fixed">
            ...
            <div class="text-center mt-6">
                <h1 class="font-suga text-[32px] text-white tracking-wide drop-shadow-sm leading-none relative z-10">Sales History</h1>
            </div>
        </div>
        ...
        <div class="relative z-20 px-[24px] -mt-6 pb-24">
            ...
            <div class="bg-[#F4F4F4] p-1 rounded-[12px] flex items-center h-[50px] mb-6 shadow-sm">
                <a href="{{ route('sales.history', ['tab' => 'ongoing']) }}"
                ...
                <a href="{{ route('sales.history', ['tab' => 'completed']) }}"
                   class="flex-1 h-full flex items-center justify-center rounded-[10px] text-[14px] font-poppins font-medium transition-all
            ...
            <div class="space-y-4 flex flex-col items-center">
                @forelse ($orders as $order)
                    ...
                    <div class="book-card">
                        ...
                        <div class="flex-1 h-full flex flex-col justify-between">
                            ...
                            <div class="flex justify-between items-end w-full">
                                ...
                                @else
                                    @php $buyerReview = $item->book->reviews->first(); @endphp
                                    ...
                                    @if($buyerReview)
                                        <div class="flex items-center border border-gray-200 px-2 py-1 rounded-[6px]">
                                            ...
                                            <span class="text-[10px] font-bold text-gray-600 ml-1">{{ $buyerReview->rating * 1 }}/5</span>
                                        </div>
                                    @else
                                        <span class="text-[10px] text-gray-400 italic">No Review</span>
                                    @endif
                                @endif
                            </div>
                        </div>
                    ...
                    @endforeach
                @empty
                    <div class="py-10 text-gray-400 text-sm text-center">
                        Belum ada penjualan. <br>
                        <span class="text-xs">(Login sebagai Seller untuk melihat data ini)</span>
                    </div>
                @endforelse
            </div>
        </div>
