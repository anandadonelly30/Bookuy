        ...
        <div class="px-4 py-6 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">Farrel!</p>
                </div>
                <a href="{{ route('cart.index') }}" class="border border-white/70 rounded-full p-3">
            ...
            <div class="bg-white rounded-full flex items-center px-4 py-2 shadow text-slate-600">
                <div class="flex items-center flex-1 gap-2">
                    ...
                    <input type="text" placeholder="Search for Books..." class="flex-1 bg-transparent focus:outline-none text-sm placeholder:text-slate-400">
                </div>
    ...
    <main class="px-4 -mt-6 space-y-8">
        ...
        <section>
            ...
            <div class="flex gap-4 overflow-x-auto pb-2">
                @forelse ($recommendedBooks as $book)
                    <a href="{{ route('books.show', $book->id) }}" class="flex-shrink-0 w-32 h-44 rounded-2xl overflow-hidden shadow bg-white relative">
                        @php
                        ...
                        @else
                            <div class="w-full h-full flex items-center justify-center text-slate-400 text-sm bg-slate-100">No cover</div>
                        @endif
        ...
        <section class="space-y-4">
            ...
            @forelse ($popularBooks as $book)
                <a href="{{ route('books.show', $book->id) }}" class="bg-white rounded-2xl shadow p-4 flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-lg font-bold mt-2 text-blue-700">Rp {{ number_format($book->price, 0, ',', '.') }}</p>
                    </div>
                    <span class="bg-orange-400 text-white text-xs font-semibold px-4 py-2 rounded-full self-start">Grab Now</span>
                </a>
            @empty
